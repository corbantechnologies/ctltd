      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="space-y-4">
          <nav>
            <ol className="flex items-center gap-2 text-[10px] font-semibold uppercase tracking-widest text-black/30">
              ...
              <li>/</li>
              <li>
                <button onClick={() => router.push(`/director/fiscal-years/${reference}`)} className="hover:text-black">{month.financial_year}</button>
              </li>
              <li>/</li>
        ...
        <div className="flex items-center gap-3 self-end md:self-center">
           <button 
             ...
             className="h-10 px-6 rounded-full bg-white border border-black/5 shadow-2xl flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-black/70 hover:bg-black hover:text-white transition-all"
           >
