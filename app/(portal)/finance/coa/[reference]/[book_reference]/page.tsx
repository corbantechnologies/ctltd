                ...
                {book?.journal_entries && book.journal_entries.length > 0 ? (
                  book.journal_entries.map((entry) => (
                    ...
                    >
                      ...
                      <td className="py-5 px-8">
                        <div className="flex items-center gap-2">
                          <Receipt className="w-3 h-3 text-[#045138]" />
                          <p className="text-base text-black">
                            {entry.reference}
                          </p>
                        </div>
                      ...
                      <td className="py-5 px-8 text-right">
                        <p className="text-base text-[#045138]">
                          {entry.currency}{" "}
                      ...
                      <td className="py-5 px-8">
                        <div className="flex justify-center">
                          <button className="w-8 h-8 rounded-lg bg-black text-white flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all hover:bg-[#045138]">
