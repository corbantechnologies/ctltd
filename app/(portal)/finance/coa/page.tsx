    ...
    <div className="space-y-6 pb-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center h-9 px-4 bg-black hover:bg-[#045138] text-white rounded-xl font-semibold text-xs transition-all shadow-md active:scale-95 group"
        >
