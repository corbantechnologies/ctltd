                ...
                {division?.partners && division.partners.length > 0 ? (
                  division.partners.map((partner: any) => (
                    <div
                      ...
                      className="group bg-white p-6 rounded-[2.5rem] border border-slate-200 hover:border-blue-600/20 hover:shadow-2xl hover:shadow-slate-100 transition-all flex items-center gap-5"
                    >
