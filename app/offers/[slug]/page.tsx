    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="fixed top-24 left-6 z-50">
        <Button
          asChild
          variant="ghost"
          className="bg-white/50 backdrop-blur-md border border-black/5 hover:bg-white hover:text-corporate-primary rounded-full px-4 font-black transition-all"
        >
      ...
      <section className="relative pt-48 pb-24 overflow-hidden">
        ...
        {/* Decorative elements */}
        <div className="absolute top-1/4 right-0 w-[400px] h-[400px] bg-orange-100/30 rounded-full blur-[100px] -z-10 animate-pulse-slow" />

        <div className="mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            <Badge className="mb-6 bg-orange-500 text-white border-none font-black uppercase tracking-widest py-2 px-6 shadow-xl shadow-orange-500/20">
              Limited Time Offer
            </Badge>
            <h1 className="text-5xl md:text-8xl font-black tracking-tighter text-corporate-foreground mb-8 leading-[0.9]">
              {offer.title.split(":")[0]}
              <span className="text-corporate-primary block mt-2 text-4xl md:text-7xl italic">
                {offer.title.split(":")[1] || ""}
              </span>
            </h1>

            <div className="flex flex-wrap gap-4 items-center">
              <div className="flex items-center gap-3 px-6 py-4 bg-white border border-black/5 rounded-3xl shadow-sm">
                <Calendar className="w-5 h-5 text-corporate-primary" />
                <span className="font-black text-corporate-foreground opacity-70 uppercase tracking-widest text-xs">
                  Expiry: {offer.validUntil}
                </span>
              </div>
              <div className="flex items-center gap-3 px-6 py-4 bg-corporate-primary text-white rounded-3xl shadow-xl shadow-orange-500/20">
        ...
        <div className="mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7 space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-8 bg-corporate-accent rounded-[40px] border border-corporate-primary/10 relative overflow-hidden group">
              ...
              <div className="p-8 bg-white border border-black/5 rounded-[40px] shadow-sm">
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 gap-6">
                  {offer.optionalAddOns.map((addon) => (
                    <div
                      key={addon.name}
                      className="p-8 bg-corporate-secondary border border-black/5 rounded-[32px] hover:border-corporate-primary/30 transition-all flex flex-col md:flex-row md:items-center justify-between gap-6 group"
                    >
            ...
            <div className="p-10 bg-black/5 rounded-[40px] border border-dashed border-black/10">
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-40">
              <div className="bg-white border border-black/5 rounded-[48px] p-10 shadow-2xl shadow-black/5 relative overflow-hidden">
                ...
                <div className="mb-10 text-center">
                  ...
                  <Badge className="mt-4 bg-orange-100 text-corporate-primary border-none font-black px-4 py-2 uppercase tracking-widest text-[10px]">
                    Limited Opportunity
                  </Badge>
                </div>
              ...
              <div className="mt-8 p-8 bg-black rounded-[32px] text-white flex items-center justify-between gap-4">
                <div>
                ...
                <Button
                  ...
                  size="sm"
                  variant="outline"
                  className="border-white/20 text-white hover:bg-white hover:text-black rounded-xl font-black"
                >
