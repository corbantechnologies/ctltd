          ...
          <CardContent className="px-8 pb-8">
            <form onSubmit={formik.handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                    className={`pl-10 h-14 bg-orange-50/50 border-black/5 rounded-md font-medium focus:bg-white transition-all tracking-[0.2em] ${formik.touched.code && formik.errors.code
                        ? "border-red-500"
                        : ""
                      }`}
                  />
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                    className={`pl-10 pr-10 h-14 bg-orange-50/50 border-black/5 rounded-md font-medium focus:bg-white transition-all ${formik.touched.confirmPassword &&
              ...
              <Button
                disabled={loading}
                type="submit"
                className="w-full h-14 bg-black hover:bg-corporate-primary text-white rounded-md text-lg font-bold shadow-xl transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-50 mt-4"
              >
                {loading ? (
