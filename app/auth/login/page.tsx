    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <div className="relative pt-24 pb-32 lg:pt-32 lg:pb-40 overflow-hidden bg-slate-900 border-b border-slate-800">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
          ...
          <div className="inline-flex items-center rounded bg-slate-800/80 backdrop-blur-md px-4 py-1.5 text-xs text-corporate-primary border border-slate-700/50 mb-6 uppercase tracking-widest shadow-inner">
