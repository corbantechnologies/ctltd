          ...
          <div className="bg-white border border-slate-200 rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-slate-200/50 relative overflow-hidden group">
            ...
            {!submitted ? (
              ...
              <div className="text-center space-y-8 animate-in fade-in zoom-in-95 duration-500">
                <div className="w-20 h-20 bg-emerald-50 rounded flex items-center justify-center border border-emerald-100 mx-auto">
                ...
                <Link
                  ...
                  className="w-full h-14 bg-slate-900 hover:bg-slate-800 text-white rounded font-semibold transition-all shadow-lg shadow-slate-900/10 flex items-center justify-center gap-3 active:scale-[0.98] group"
                >
