    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white px-6">
        <div className="text-center">
          ...
          <Button
            asChild
            className="bg-corporate-primary hover:bg-orange-600 rounded-2xl px-8 py-6 h-auto font-black shadow-lg shadow-orange-500/20"
          >
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
            <div className="max-w-3xl">
              <div className="flex items-center gap-3 mb-4">
                <Badge className="bg-orange-100 text-corporate-primary border-orange-200 font-black uppercase tracking-widest py-1.5 px-4 shadow-sm text-[10px]">
                  Case Study
                </Badge>
                {project.featured && (
                  <Badge className="bg-black text-white font-black uppercase tracking-widest py-1.5 px-4 shadow-sm text-[10px]">
                    Featured
                  </Badge>
                )}
              </div>
              ...
              <p className="text-corporate-foreground text-xl md:text-2xl leading-relaxed font-black opacity-70">
            ...
            {project.website && (
              <Button
                asChild
                size="lg"
                className="bg-corporate-primary hover:bg-orange-600 text-white rounded-2xl px-10 py-8 text-lg font-black shadow-2xl shadow-orange-500/40 border-none transition-all hover:scale-105 group w-full lg:w-auto"
              >
                <Link
        ...
        <div className="mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-8 space-y-16">
              <div className="bg-white p-10 md:p-16 rounded-[48px] border border-black/5 shadow-sm">
                <h3 className="text-2xl font-black text-corporate-foreground mb-8 flex items-center gap-4 tracking-tighter">
                  <div className="w-10 h-10 rounded-2xl bg-orange-100 flex items-center justify-center text-corporate-primary">
                ...
                <div className="space-y-6">
                  {project.fullDescription.map((para, i) => (
                    <p
                      key={i}
                      className="text-lg md:text-xl text-corporate-foreground opacity-60 font-bold leading-relaxed italic border-l-4 border-orange-200 pl-6"
                    >
                      {para}
                    </p>
                  ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white p-10 rounded-[40px] border border-black/5 shadow-sm hover:shadow-xl transition-all">
            ...
            <div className="lg:col-span-4 space-y-8">
              <div className="bg-white p-10 rounded-[40px] border border-black/5 shadow-sm sticky top-32">
                ...
                <div className="flex flex-wrap gap-3 mb-12">
                  {project.techStack.map((tech) => (
                    <Badge
                      key={tech}
                      variant="outline"
                      className="text-[11px] uppercase font-black tracking-widest border-black/10 text-corporate-foreground py-2 px-6 bg-orange-50/50 rounded-xl hover:bg-orange-50 transition-colors"
                    >
                      {tech}
                    </Badge>
                  ))}
                ...
                <div className="pt-10 border-t border-black/5">
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="w-full border-black/10 hover:border-corporate-primary text-corporate-foreground hover:text-corporate-primary rounded-2xl py-8 h-auto font-black uppercase tracking-widest text-xs transition-all shadow-md hover:bg-orange-50"
                  >
