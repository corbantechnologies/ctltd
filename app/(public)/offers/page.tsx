          ...
          {offers.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {offers.map((offer) => (
                <Card
                  key={offer.slug}
                  className="bg-white border-black/5 hover:border-corporate-primary/30 transition-all group shadow-sm hover:shadow-xl rounded-none overflow-hidden flex flex-col"
                >
                  <CardHeader className="p-10 pb-0">
                    <div className="flex justify-between items-start mb-8">
                      <div className="w-16 h-16 rounded-none bg-orange-100 flex items-center justify-center text-corporate-primary group-hover:bg-corporate-primary group-hover:text-white transition-all shadow-sm">
                        <Tag className="w-8 h-8" />
                      </div>
                      <Badge
                        variant="outline"
                        className="border-corporate-primary/20 text-corporate-primary font-bold px-4 py-1 rounded-none text-[10px] uppercase tracking-wider"
                      >
                        Save{" "}
                  ...
                  <CardContent className="p-10 pt-0 flex-grow flex flex-col">
                    ...
                    <div className="mb-8 p-6 bg-corporate-accent rounded-none border border-corporate-primary/10">
            ...
            <div className="max-w-4xl mx-auto py-24 text-center space-y-8 bg-white rounded-none border border-black/5 shadow-sm">
              <div className="w-24 h-24 bg-orange-100 rounded-none flex items-center justify-center text-corporate-primary mx-auto shadow-inner">
              ...
              <Button
                asChild
                variant="outline"
                className="border-corporate-primary/20 text-corporate-primary hover:bg-orange-50 rounded-none px-10 py-6 h-auto font-bold uppercase tracking-widest text-xs"
              >
