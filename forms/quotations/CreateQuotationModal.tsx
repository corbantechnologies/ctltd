  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl bg-white rounded shadow-2xl z-[101] overflow-hidden animate-in zoom-in-95 duration-300 border border-slate-200">
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <input
                    ...
                    className="w-full h-14 px-6 rounded bg-slate-50 border border-transparent focus:border-blue-600 focus:bg-white font-semibold text-sm transition-all"
                  />
                </div>
                <div className="space-y-4">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-black flex items-center gap-2">
              ...
              <div className="space-y-4">
                ...
                <textarea
                  ...
                  className="w-full h-32 p-6 rounded bg-slate-50 border border-transparent focus:border-blue-600 focus:bg-white font-medium text-sm resize-none transition-all"
                />
              </div>
            </div>
