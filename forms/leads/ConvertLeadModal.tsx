  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-white rounded-[40px] shadow-2xl z-[101] overflow-hidden animate-in zoom-in-95 duration-300 border border-slate-200">
          ...
          <div className="p-10 space-y-10">
                ...
                {partnerTypes?.map((type) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "flex items-center justify-between p-6 rounded-3xl border-2 transition-all group relative overflow-hidden",
                        isSelected 
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full h-16 bg-blue-600 hover:bg-blue-700 text-white rounded-[28px] font-bold text-sm uppercase tracking-widest transition-all shadow-2xl shadow-blue-600/20 disabled:opacity-50 disabled:shadow-none active:scale-95 flex items-center justify-center gap-3"
              >
