...
export default function AccountDistributionChart({ data }: AccountDistributionChartProps) {
    const chartData: ChartData[] = data.map((coa) => ({
        name: coa.name,
    ...
    return (
        <Card className="col-span-1 shadow-xl shadow-black/5 border-none rounded-[32px] bg-white/60 backdrop-blur-xl">
            <CardHeader>
                <CardTitle className="text-xl font-black text-black">Books Distribution</CardTitle>
            </CardHeader>
            <CardContent>
