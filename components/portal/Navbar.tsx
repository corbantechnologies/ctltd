            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-none text-black hover:bg-orange-50"
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-black/5 flex items-center justify-between">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="rounded-none hover:bg-orange-50"
              onClick={() => setMenuOpen(false)}
            >
              <X className="w-6 h-6" />
            </Button>
          ...
          <div className="p-6 bg-orange-50/30">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-none bg-orange-100 flex items-center justify-center text-corporate-primary font-bold text-lg">
              ...
              .map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    className={cn(
                      "flex items-center justify-between p-4 rounded-none font-bold text-sm transition-all group",
                      isActive
          ...
          <div className="p-6 border-t border-black/5">
            <Button
              variant="outline"
              className="w-full h-14 bg-black hover:bg-red-600 text-white hover:text-white rounded-none font-bold flex items-center justify-center gap-3 transition-all border-none"
